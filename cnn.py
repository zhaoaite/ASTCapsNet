...
batch_size=128
a=np.loadtxt("/home/zat/zresearch/capsulenet/associated-stcapsnet/data/unito/KINECTUNITO.txt")
#a=normalize(a+1,'l2')
#a=a+1
print(a.shape)
b=np.loadtxt("/home/zat/zresearch/capsulenet/associated-stcapsnet/data/unito/UNITOLABEL.txt")
b=b-1
...
print(pool2)
#flat(平坦化)
flat=tf.reshape(pool2,[-1,3*2*64])
...
print("------",test_accuracy)
np.savetxt('pd_predict_cnn.csv',np.argmax(test_output,1))
np.savetxt('pd_true_cnn.csv',label_test)
