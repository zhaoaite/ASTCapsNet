...
a=np.load("/home/zat/zresearch/capsulenet/associated-stcapsnet/data/casia/casia_gait_data.npy")
#a=normalize(a+1,'l2')
#a=a+1
print(a.shape)
b=np.loadtxt("/home/zat/zresearch/capsulenet/associated-stcapsnet/data/casia/casia_gait_label.txt")
b=b-1
...
#    
    ...
    np.savetxt('casia_score_lstm.csv',pred_score)
    np.savetxt('casia_true_lstm.csv',test_label)
